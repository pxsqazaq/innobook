      ...
      <section class="viewbook">
        <div class="container">
            <div class="viewbook_link">
                ...
                <span>/</span>
                <a href="gugo.php">Отверженные</a>   
            </div>
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="./assets/img/отверженные.jpg" alt="">
                </div>
            ...
            <div class="viewbook_downloadbtn">
                <a href="./assets/books/Отверженные. Виктор Гюго.pdf" download>Download PDF</a>
            </div>
        </div>
    </section>
