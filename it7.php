        ...
        <div class="container">
            ...
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="https://habrastorage.org/r/w1560/getpro/habr/post_images/713/fdb/b0c/713fdbb0ce247bc76974ad695de1152c.jpg" alt="">
                </div>
                <div class="about_book-text">
                    <div class="about_book-title">
                        <h2>Make Your Own Neural Network</h2>
                    ...
                    <p>A step-by-step gentle journey through the mathematics of neural networks, and making your own using the Python computer language.
Neural networks are a key element of deep learning and artificial intelligence, which today is capable of some truly impressive feats. Yet too few really understand how neural networks actually work.</p>
                </div>
            </div>
            <div class="viewbook_downloadbtn">
                
                <a href="https://media.oiipdf.com/pdf/4bd42783-455e-47e2-a923-ae0fa2ddfd69.pdf" download>Download PDF</a>
