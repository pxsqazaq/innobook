        ...
        <div class="container">
            ...
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="./assets/img/пофигизм.jpg" alt="">
                </div>
                <div class="about_book-text">
                    <div class="about_book-title">
                        <h2>Тонкое искусство пофигизма</h2>
