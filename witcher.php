      ...
      <section class="viewbook">
        <div class="container">
            <div class="viewbook_link">
                ...
                <span>/</span>
                <a href="witcher.php">Ведьмак</a>   
            </div>
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="./assets/img/witcher.jpg" alt="">
                </div>
                <div class="about_book-text">
                    ...
                    <p>Всего "Меч Предназначения" включает в себя шесть законченных рассказов, где, помимо ведьмака Геральта, фигурируют другие важные для цикла персонажи. В "Вечном огне" снова появляется жизнерадостный и неутомимый пройдоха-бард Лютик, в "Осколке льда" - прекрасная и гордая Йеннифэр, возлюбленная героя и его вечное наказание, даст знать о себе в странном, сложном треугольнике. Используя узнаваемые мотивы, Сапковский иронично обыгрывает историю "красавица и чудовище" в жутком и проникновенном сюжете под названием "Немного жертвенности", а Цири посвящены заглавный "Меч Предназначения" и "Нечто большее", закрывающие сборник.</p>
                </div>
            </div>
      
            <div class="viewbook_downloadbtn">
                <a href="./assets/books/Меч Предназначения. Анджей Сапковский.pdf" download>Download PDF</a>
            </div>
        </div>
    </section>
