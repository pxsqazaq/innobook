      ...
      <section class="viewbook">
        <div class="container">
            <div class="viewbook_link">
                ...
                <span>/</span>
                <a href="oscar.php">Портрет Дориана Грея</a>   
            </div>
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="./assets/img/портретдориана.jpg" alt="">
                </div>
                <div class="about_book-text">
                    ...
                    <p>«Портре́т Дориа́на Гре́я» — роман ирландского писателя и драматурга Оскара Уайльда. В жанровом отношении представляет смесь романа воспитания с моральной притчей; оказался самым успешным произведением Уайльда, экранизировался в разных странах мира более 30 раз.</p>
                </div>
            </div>
      
            <div class="viewbook_downloadbtn">
                <a href="./assets/books/Портрет Дориана Грея. Оскар Уайльд.pdf" download>Download PDF</a>
            </div>
        </div>
    </section>
