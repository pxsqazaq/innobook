        ...
        <div class="container">
            ...
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="https://habrastorage.org/r/w1560/getpro/habr/post_images/c32/d97/037/c32d970370d8732049e9a0e97f86d2e6.jpg" alt="">
                </div>
                <div class="about_book-text">
                    <div class="about_book-title">
                        <h2>The Definitive Guide to Programming Professionally</h2>
                    ...
                    <p>One of the best software design books of all time' - BookAuthorityCory Althoff is a self-taught programmer. After a year of self-study, he learned to program well enough to land a job as a software engineer II at eBay.</p>
                </div>
            </div>
            <div class="viewbook_downloadbtn">
                
                <a href="assets/books/theselftaught.pdf" download>Download PDF</a>
