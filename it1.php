        ...
        <div class="container">
            ...
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="./assets/img/javascriptдлядетей.png" alt="">
                </div>
                <div class="about_book-text">
                    ...
                    <p>Вы узнаете, как создавать простые HTML-странички и напишете текстовую версию игры «Виселица». Часть 2 знакомит с более продвинутыми техниками, включая jQuery, объектно-ориентированное программирование, запуск кода по таймеру и реакцию на действия пользователя и др.</p>
                </div>
            </div>
            <div class="viewbook_downloadbtn">
                
                <a href="assets/books/JavaScript_для_детей._Самоучитель_по_программированию.pdf" download>Download PDF</a>
