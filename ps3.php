        ...
        <div class="container">
            ...
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="./assets/img/выйдииззоныкомфорта.jpg" alt="">
                </div>
                <div class="about_book-text">
                    <div class="about_book-title">
                        <h2>Выйди из зоны комфорта</h2>
                    ...
                    <p>Эта книга – результат тридцатилетней работы автора, который подробно исследовал проблему планирования времени, изучив сотни публикаций о личной эффективности. Брайан Трейси наглядно демонстрирует, как можно одновременно построить карьеру и при этом находить время на семью и даже личностное развитие.
.</p>
                </div>
            </div>
            <div class="viewbook_downloadbtn">
                
                <a href="assets/books/Выйди из зоны комфорта. Измени свою жизнь. 21 метод повышения личной эффективности ( PDFDrive ).pdf" download>Download PDF</a>
