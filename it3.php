        ...
        <div class="container">
            ...
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="https://habrastorage.org/r/w1560/getpro/habr/post_images/070/bea/082/070bea0827a6592222ab27e3944d8ab2.jpg" alt="">
                </div>
                <div class="about_book-text">
                    <div class="about_book-title">
                        <h2>The Complete Software Developer's Career Guide</h2>
                    ...
                    <p>This book is different from all other software development books I have read because it deals with the human side of software development. Even though as software developers we are surrounded with the latest technology, we are still people with feelings, fears and dreams, and John's book focuses on that.</p>
                </div>
            </div>
            <div class="viewbook_downloadbtn">
                
                <a href="assets/books/thecompletesodtware.pdf" download>Download PDF</a>
