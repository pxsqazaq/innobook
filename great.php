      ...
      <section class="viewbook">
        <div class="container">
            <div class="viewbook_link">
                ...
                <span>/</span>
                <a href="great.php">Великий Гэтсби</a>   
            </div>
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="./assets/img/великий_гэтсби.jpg" alt="">
                </div>
                <div class="about_book-text">
                    ...
                    <h3>Фрэнсис Скотт Фицджеральд, 1925</h3>
                    ...
                    <p>В центре сюжета — любовная история с детективной и трагической развязкой. Действие развивается недалеко от Нью-Йорка, на «золотом побережье» Лонг-Айленда, среди вилл богачей. В 1920-е годы вслед за хаосом Первой мировой начался экономический бум и американское общество вступило в беспрецедентную полосу процветания. В то же время «сухой закон» сделал многих бутлегеров миллионерами и дал значительный толчок развитию организованной преступности.</p>
                </div>
            </div>
      
            <div class="viewbook_downloadbtn">
                <a href="./assets/books/Velikiy-Getsbi pdf.pdf" download>Download PDF</a>
            </div>
        </div>
    </section>
