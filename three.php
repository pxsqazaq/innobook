      ...
      <section class="viewbook">
        <div class="container">
            <div class="viewbook_link">
                ...
                <span>/</span>
                <a href="three.php">Три товарища</a>   
            </div>
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="./assets/img/тритоварища.jpg" alt="">
                </div>
                <div class="about_book-text">
                    ...
                    <p>Послевоенная Германия середины двадцатых годов прошлого века. Трое друзей – Готтфрид Ленц, Отто Кестер и Роберт Локамп – пытаются привыкнуть к мирной жизни после ужасов, с которыми им довелось столкнуться на фронте. Молодые мужчины открывают небольшую автомастерскую, а в свободное время проводят вечера в барах и гоняют на «Карле» – старой, но мощной колымаге.</p>
                </div>
            </div>
      
            <div class="viewbook_downloadbtn">
                <a href="./assets/books/Три товарища. Эрих Мария Ремарк.pdf" download>Download PDF</a>
            </div>
        </div>
    </section>
