      ...
      <section class="viewbook">
        <div class="container">
            <div class="viewbook_link">
                ...
                <span>/</span>
                <a href="libardugo.php">Шестерка воронов</a>   
            </div>
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="./assets/img/шестеркаворонов.jpg" alt="">
                </div>
                <div class="about_book-text">
                    <div class="about_book-title">
                        <h2>Шестерка воронов</h2>
                        <a href="#!"><i class='bx bx-heart'></i></a>
                    </div>
                    <h3>Ли Бардуго,2018</h3>
                    ...
                    <p>Кеттердам – шумный центр международной торговли, где по сходной цене можно купить все, и лучше других это знает юный гений преступного мира Каз Бреккер. Ему выпадает шанс на ограбление века, которое может сделать его невообразимо богатым. Но один он не справится… Узник, обуреваемый жаждой мести. Стрелок, который любит испытывать судьбу. Беглец из высших слоев общества. Шпионка, известная под кличкой Призрак. Девушка из магического ордена гришей с необычным даром. Вор с талантом выходить сухим из воды. Шесть опасных изгоев. Одно невозможное похищение.</p>
                </div>
            </div>
      
            <div class="viewbook_downloadbtn">
                <a href="./assets/books/Shesterka-voronov pdf.pdf" download>Download PDF</a>
            </div>
        </div>
    </section>
