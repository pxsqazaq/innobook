      ...
      <section class="viewbook">
        <div class="container">
            <div class="viewbook_link">
                ...
                <span>/</span>
                <a href="dan.php">Происхождение</a>   
            </div>
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="./assets/img/происхождение.jpg" alt="">
                </div>
                ...
                <div class="about_book-title">
                   ...
                   <p>Роберт Лэнгдон, Гарвардский профессор религиозной символогии, прибывает в сверхсовременный музей Гуггенхейма в Бильбао, чтобы присутствовать при важном объявлении — открытии, которое «изменит лицо науки навсегда». Вечером Эдмонд Кирш, сорокалетний миллиардер и футуролог, чьи высокотехнологичные изобретения и смелые прогнозы сделали его всемирно известной фигурой, собирается раскрыть удивительный прорыв, который даст ответы на два фундаментальных вопроса человеческого существования: «Откуда мы пришли?» и «Куда мы идём?». Кирш был одним из первых студентов Лэнгдона в Гарвардском университете двумя десятилетиями ранее.</p>
            <div class="viewbook_downloadbtn">
                <a href="./assets/books/Proishozhdenie pdf.pdf" download>Download PDF</a>
            </div>
        </div>
    </section>
