      ...
      <section class="viewbook">
        <div class="container">
            <div class="viewbook_link">
                ...
                <span>/</span>
                <a href="margaret.php">Унесенные ветром</a>   
            </div>
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="./assets/img/унесенные_ветром_том1.jpg" alt="">
                </div>
                <div class="about_book-text">
                    <div class="about_book-title">
                        <h2>Унесенные ветром</h2>
                        <a href="#!"><i class='bx bx-heart'></i></a>
                    </div>
                    <h3>Маргарет Митчелл</h3>
                    ...
                    <p>Незабываемый любовный роман времен американской Гражданской войны. Бессмертным героям этой эпической саги Скарлетт, Ретт, Эшли, Мелани, Матушка и Присси — удалось покорить не одно поколение кинозрителей.</p>
                </div>
            </div>
      
            <div class="viewbook_downloadbtn">
                <a href="./assets/books/Унесенные ветром. Маргарет Митчелл.pdf" download>Download PDF</a>
            </div>
        </div>
    </section>
