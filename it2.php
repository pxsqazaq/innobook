        ...
        <div class="container">
            ...
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="./assets/img/изучаемjava.jpg" alt="">
                </div>
                <div class="about_book-text">
                    ...
                    <p>“Изучаем Java” – это не просто книга. Она не только научит вас теории языка Java и объектно-ориентированного программирования, она сделает вас программистом. В ее основу положен уникальный метод обучения на практике.</p>
                </div>
            </div>
            <div class="viewbook_downloadbtn">
                
                <a href="assets/books/изучаемджава.pdf" download>Download PDF</a>
