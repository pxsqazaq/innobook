      ...
      <section class="viewbook">
        <div class="container">
            <div class="viewbook_link">
                ...
                <span>/</span>
                <a href="princess.php">Маленькая принцесса</a>   
            </div>
            <div class="about_book">
                <div class="about_book-img">
                    <img class="verybig_img" src="assets/img/alittleprincess .jpg" alt="">
                </div>
                <div class="about_book-text">
                    <div class="about_book-title">
                        <h2>Маленькая принцесса</h2>
                        <a href="#!"><i class='bx bx-heart'></i></a>
                    </div>
                    <h3>Фрэнсис Бёрнет, 1905</h3>
                ...
                <p>«Маленькая принцесса» — роман для детей английской писательницы Фрэнсис Элизы Бёрнетт. По опросу 2007 года, проведённому Национальной Ассоциацией Образования США, роман «Маленькая принцесса» вошёл в Топ-100 детских книг, рекомендуемых для школ.</p>
                </div>
            </div>
      
            <div class="viewbook_downloadbtn">
                <a href="./assets/books/princess.pdf" download>Download PDF</a>
            </div>
        </div>
    </section>
